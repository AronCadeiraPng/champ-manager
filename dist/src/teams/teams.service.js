...
let TeamsService = class TeamsService {
    ...
    usersRepository;
    usersService;
    constructor(teamsRepository, usersRepository, usersService) {
    ...
    async createTeam(createTeamDto) {
        ...
        if (teamExists)
            throw new bad_request_exception_1.BadRequestException('Já existe um time com este nome!', 400);
        return this.teamsRepository.save(createTeamDto);
    }
    async addPlayer(team, userId) {
