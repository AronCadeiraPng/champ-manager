...
export declare class MatchPairService {
    ...
    constructor(matchShuffleService: MatchShuffleService, matchCreateService: MatchCreateService, playerCreateService: PlayerCreateService);
    execute(phaseId: string, participantsDto: Participant[]): Promise<any>;
}
