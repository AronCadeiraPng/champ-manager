...
exports.SportCreateService = void 0;
...
let SportCreateService = class SportCreateService {
    sportRepository;
    sportFindService;
    ...
    async create(createSportDto) {
        const sportExists = await this.sportFindService.findSportByName(createSportDto.name);
        if (sportExists)
            throw new bad_request_exception_1.BadRequestException('Esporte com este nome já existe!', 400);
        const sport = this.sportRepository.create(createSportDto);
        return this.sportRepository.save(sport);
    }
};
exports.SportCreateService = SportCreateService;
exports.SportCreateService = SportCreateService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(sport_entity_1.Sport)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        find_sport_service_1.SportFindService])
], SportCreateService);
//# sourceMappingURL=create-sport.service.js.map