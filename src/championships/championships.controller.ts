...
export class ChampionshipsController {
  ...
  @Delete('delete/:id')
  async deleteChampionship(@Param('id', ParseUUIDPipe) id: string) {
    return this.championshipsService.deleteChampionship(id)
  }

  @Patch('update/:id')
  async updateChampionship(@Param('id', ParseUUIDPipe) id: string,@Body() updateChampionshipDto: UpdateChampionshipDto) 
   {
  ...
  async findChampionshipById(@Param('id', ParseUUIDPipe) id: string) {
