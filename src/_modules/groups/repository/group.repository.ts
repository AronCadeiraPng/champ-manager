...
import { PhaseEnum } from "../../../_common/enums/phase-name.enum";import { UpdateGroupDto } from "../models/dtos/update-group.dto";
;
...
export abstract class GroupRepository {
  ...
  abstract update(updateGroupDto: UpdateGroupDto, id: string): Promise<UpdateResult>;
}